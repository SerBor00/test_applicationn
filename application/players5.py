...
class players5(Screen):
    def __init__(self, **kwargs):
        ...
        grid_bl =  BoxLayout(size_hint=(1, None), height=1200, padding= (1 , 1 , 1 , 610 ))
        grid_per = GridLayout(cols = 5 ,  height=100, padding= (1 , 1 , 1 , 1 ), spacing=(65 , 10))
        grid_post = GridLayout(cols=3, rows=3, spacing=(1 , 1), padding= (5 , 1 , 1 , 1 ), size_hint_y=None, height= 130)
        ...
        grid_post.add_widget(Label(text= "имя фамилия" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (162 , 32) ))
        grid_post.add_widget(Label(text= "имя фамилия" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (162 , 32) ))
        grid_post.add_widget(Label(text= "" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (250 , 32) ))
        self.first_post_name = TextInput(hint_text= "Имя Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (162 , 48))
        grid_post.add_widget(self.first_post_name)
        self.second_post_name = TextInput(hint_text= "Имя Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (162 , 48))
        grid_post.add_widget(self.second_post_name)
        grid_post.add_widget(Label(text= "" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (250 , 48) ))
        self.first_post = TextInput(hint_text= "199.6", size_hint_y=None, height= 32, size_hint=(None, None) , size = (162 , 32))
        grid_post.add_widget(self.first_post)
        self.second_post = TextInput(hint_text= "199.6", size_hint_y=None, height= 32, size_hint=(None, None) , size = (162 , 32))
        grid_post.add_widget(self.second_post)
        grid_post.add_widget(Label(text= "результаты постановок" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (250 , 32) ))
        ...
        gl.add_widget(Label(text= "имя фамилия" , color = "#02034e", size_hint_y=None, height= 32 , font_size =22 , size_hint=(None, None) , size = (162 , 32)))
        gl.add_widget(Label(text= "имя фамилия" , color = "#02034e", size_hint_y=None, height= 32 , font_size =22 , size_hint=(None, None) , size = (162 , 32)))
        gl.add_widget(Label(text= "броска" , color = "#02034e", size_hint_y=None, height= 50 , font_size =20 , size_hint=(None, None) , size = (68 , 48)))
        self.name_1 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (163 , 48))
        gl.add_widget(self.name_1)
        self.name_2 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (163 , 48))
        gl.add_widget(self.name_2)
        self.name_3 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (163 , 48))
        gl.add_widget(self.name_3)
        self.name_4 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (163 , 48))
        gl.add_widget(self.name_4)
        self.name_5 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32, size_hint=(None, None) , size = (163 , 48))
        ...
        gl2.add_widget(Label(text="end-1", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-1", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_5)
        self.one_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.two_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.two_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.two_5)
        self.two_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.two_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.two_5_button)
        self.end_one_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-2", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.three_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-2", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.three_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.three_5)
        self.three_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.four_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.four_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.four_5)
        self.four_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.four_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.four_5_button)
        self.end_two_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-3", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.five_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-3", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.five_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.five_5)
        self.five_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.six_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.six_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.six_5)
        self.six_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.six_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.six_5_button)
        self.end_three_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-4", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.seven_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-4", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.seven_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.seven_5)
        self.seven_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.eight_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.eight_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.eight_5)
        self.eight_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.eight_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.eight_5_button)
        self.end_four_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-5", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.nine_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-5", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.nine_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.nine_5)
        self.nine_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.one_zero_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.one_zero_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_zero_5)
        self.one_zero_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.one_zero_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.one_zero_5_button)
        self.end_five_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-6", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_one_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-6", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_one_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_one_5)
        self.one_one_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.one_two_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.one_two_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_two_5)
        self.one_two_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.one_two_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.one_two_5_button)
        self.end_six_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-7", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_three_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-7", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_three_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_three_5)
        self.one_three_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.one_four_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.one_four_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_four_5)
        self.one_four_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.one_four_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.one_four_5_button)
        self.end_seven_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-8", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_five_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-8", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_five_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_five_5)
        self.one_five_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.one_six_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.one_six_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_six_5)
        self.one_six_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.one_six_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.one_six_5_button)
        self.end_eight_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-9", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_seven_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-9", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_seven_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_seven_5)
        self.one_seven_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.one_eight_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.one_eight_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_eight_5)
        self.one_eight_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.one_eight_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.one_eight_5_button)
        self.end_nine_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="end-10", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_nine_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="end-10", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.one_nine_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.one_nine_5)
        self.one_nine_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.two_zero_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.two_zero_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.two_zero_5)
        self.two_zero_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.two_zero_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.two_zero_5_button)
        self.end_ten_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="ex.end-1", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_one_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="ex.end-1", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_one_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_one_5)
        self.extra_one_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.extra_two_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.extra_two_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_two_5)
        self.extra_two_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.extra_two_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.extra_two_5_button)
        self.extra_end_one_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="ex.end-2", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_three_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="ex.end-2", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_three_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_three_5)
        self.extra_three_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.extra_four_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.extra_four_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_four_5)
        self.extra_four_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.extra_four_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.extra_four_5_button)
        self.extra_end_two_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        gl2.add_widget(Label(text="ex.end-3", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_five_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        gl2.add_widget(Label(text="ex.end-3", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18))
        self.extra_five_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_five_5)
        self.extra_five_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        ...
        self.extra_six_4 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        ...
        self.extra_six_5 = TextInput(hint_text= "от 0 до 4", input_filter=inp_filter, size_hint=(None, None) , size = (45 , 50))
        gl2.add_widget(self.extra_six_5)
        self.extra_six_5_button = Button(text="-", size_hint=(None, None) , size = (44 , 50))
        self.extra_six_5_button.bind(on_release=self.switch_button_type)
        gl2.add_widget(self.extra_six_5_button)
        self.extra_end_three_5 = Label(text="", color = "#02034e", size_hint=(None, None) , size = (75 , 50), font_size =18)
        ...
        self.final_percentage_5 = Label(text="" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (70 , 32) , padding = (440 , 850 , 1 , 1))
        ...
        self.types_throw_5 = Label(text="" , color = "#02034e", size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (70 , 32) , padding = (480 , 900 , 1 , 1))
