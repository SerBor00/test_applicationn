...
class fst_page(Screen):
    def __init__(self, **kwargs):
        ...
        bl = BoxLayout()
        match_p = Button(text="Игра+"  , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint=(None, None) , size = (270 , 60))
        player_p = Button(text="Игрок+" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint=(None, None) , size = (270 , 60))
        archive = Button(text="Архив"  , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint=(None, None) , size = (270 , 60))
