...
class players3(Screen):
    def __init__(self, **kwargs):
        ...
        gl = GridLayout(cols= 4 , spacing=(1 , 1) , padding= (1 , 1 , 1 , 1))
        ...
        grid_bl =  BoxLayout(size_hint=(1, None), height=500, padding= (1 , 1 , 1 , 610 ))
        grid_per = GridLayout(cols = 4 ,  height=100, padding= (1 , 390 , 1 , 1 ), spacing=(1 , 10))
        grid_post = GridLayout(cols=3, rows=3, spacing=(7 , 4), padding= (5 , 1 , 1 , 1 ), size_hint_y=None, height= 130)
        head =  BoxLayout(size_hint=(1, None), height=450, padding= (0 , 1 , 1 , 1200 ))
        #application/shrift/LRegular..ttf
        #application/shrift/Nunito..ttf
        bl.add_widget(Label(text= "дата игры" , color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =24 , size_hint=(None, None) , size = (125 , 32)))
        ...
        bl.add_widget(Label(text= "название команды"  , color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =24 , size_hint=(None, None) , size = (230 , 32) ))
        ...
        bl.add_widget(Label(text= "название игры"  , color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =24 , size_hint=(None, None) , size = (185 , 32)))
        ...
        self.anal__1 = Label(text="",  color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 64 , font_size =20, size_hint=(None, None) , size = (58 , 68))
        ...
        self.types_throw_1 = Label(text="",  color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (165 , 68) , halign = 'center' , valign = 'center')
        grid_per.add_widget(self.types_throw_1)
        self.types_throw_2 = Label(text="",  color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (165 , 68) , halign = 'center' , valign = 'center') 
        grid_per.add_widget(self.types_throw_2)
        self.types_throw_3 = Label(text="",  color = "#02034e" , font_name = 'application/shrift/TT Norms Pro Medium.otf', size_hint_y=None, height= 32 , font_size =20, size_hint=(None, None) , size = (165 , 68) , halign = 'center' , valign = 'center')
        grid_per.add_widget(self.types_throw_3)
        
        self.save_info = Label(text="" , font_name = 'application/shrift/TT Norms Pro Medium.otf', pos=(120, -60))
    ...
    def switch_match_plus(self, instance, *args):
        ...
        listik = [[self.one_1, self.two_1, self.three_1, self.four_1, self.five_1, self.six_1, self.seven_1, self.eight_1, self.nine_1, self.one_zero_1,
                  ...
                  self.two_zero_3, self.extra_one_3, self.extra_two_3, self.extra_three_3, self.extra_four_3, self.extra_five_3, self.extra_six_3]]
        ...
        type_listik = [[self.one_1_button, self.two_1_button, self.three_1_button, self.four_1_button, self.five_1_button, self.six_1_button, self.seven_1_button, self.eight_1_button, self.nine_1_button,
                       ...
                       self.extra_four_3_button, self.extra_five_3_button, self.extra_six_3_button]]
